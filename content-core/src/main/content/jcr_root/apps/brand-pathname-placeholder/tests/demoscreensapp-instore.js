...
(function(window, hobs) {
    ...
    new hobs.TestSuite('Screens - brand-name-placeholder Instore Demo',
        {path: '/apps/brand-pathname-placeholder/tests/brand-pathname-placeholder-instore.js', register: true})

        // The app should have some initial structure
        .addTestCase(new hobs.TestCase('App structure', {demoMode: DEBUG})
            .navigateTo('/content/screens/brand-pathname-placeholder/apps/virtual-showroom.html')
