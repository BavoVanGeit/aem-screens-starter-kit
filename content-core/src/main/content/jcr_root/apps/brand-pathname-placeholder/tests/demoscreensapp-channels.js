...
(function(window, hobs) {
    ...
    new hobs.TestSuite('Screens - brand-name-placeholder Channels',
        {path: '/apps/brand-pathname-placeholder/tests/brand-pathname-placeholder-channels.js', register: true})

        .addTestCase(new hobs.TestCase('Idle channel sequence', {
            demoMode: DEBUG,
            after: hobs.screens.steps.resetContext
        })
            .navigateTo(PLAYER_PATH + '/content/screens/brand-pathname-placeholder/locations/demo/flagship/single/device0?date=' + new Date(new Date().setHours(10)).toISOString())
            .wait(3000)
        ...
        .addTestCase(new hobs.TestCase('Idle-Night channel sequence', {
            ...
            .navigateTo(PLAYER_PATH + '/content/screens/brand-pathname-placeholder/locations/demo/flagship/single/device0?date=' + new Date(new Date().setHours(20)).toISOString())
            .wait(3000)
            .screens.setChannelContext()
        ...
        .addTestCase(new hobs.TestCase('Attraction loop', {
            ...
            .wait(3000)
            .screens.setChannelContext()
            .asserts.exists('body[data-apppath="' + data.app.brand-pathname-placeholder.path + '"]')
            .asserts.isVisible([selectors.app.brand-pathname-placeholder.catalog.cover.view,
                selectors.app.brand-pathname-placeholder.catalog.cover.background +
                selectors.app.brand-pathname-placeholder.catalog.cover.demo].join(' '))
            .asserts.isInViewport([selectors.app.brand-pathname-placeholder.catalog.cover.view,
                selectors.app.brand-pathname-placeholder.catalog.cover.background +
                selectors.app.brand-pathname-placeholder.catalog.cover.demo].join(' '))
        ...
        .addTestCase(new hobs.TestCase('Dual zone', {
            ...
            .navigateTo(PLAYER_PATH + '/content/screens/brand-pathname-placeholder/locations/demo/flagship/zdual/device0')
            .wait(3000)
