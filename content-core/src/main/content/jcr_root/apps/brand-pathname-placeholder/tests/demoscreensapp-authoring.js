...
(function(window, hobs) {
    ...
    new hobs.TestSuite('Screens - brand-name-placeholder Authoring',
        {path: '/apps/brand-pathname-placeholder/tests/brand-pathname-placeholder-authoring.js', register: true})

        .addTestCase(new hobs.TestCase('Sequence - Allowed Components', {demoMode: DEBUG})
            .navigateTo('/editor.html/content/screens/brand-pathname-placeholder/channels/idle.edit.html')
            ...
            .asserts.isTrue(function() {
                ...
                return components['/content/screens/brand-pathname-placeholder/channels/idle/jcr:content/par'] &&
                    components['/content/screens/brand-pathname-placeholder/channels/idle/jcr:content/par'].length > 0;
            })
            .asserts.isTrue(function() {
