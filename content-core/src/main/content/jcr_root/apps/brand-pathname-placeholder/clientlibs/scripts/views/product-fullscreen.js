 ...
 */
define('brand-pathname-placeholder/views/product-fullscreen', [
    'underscore',
    'jquery',
    'util/Util',
    'views/BaseView',
    ...
    'brand-pathname-placeholder/views/product-thumbnail',
    'brand-pathname-placeholder/views/product-description',
    'brand-pathname-placeholder/views/product-list',
    ...
    var DEFAULT_OPTIONS = {
        ...
        left: 0,
        parent: null,
        parentClassName: '.geo-App',
        drawerClass: 'geo-ProductFullscreenView-drawer',
        handleClass: 'geo-ProductFullscreenView-handle',
        contentClass: 'geo-ProductFullscreenView-content',
        pullDirection: 'left',
    ...
    var FullScreenView = DrawerComponentView.extend(/** @lends FullScreenView.prototype */ {
         ...
         * @type {String}
         */
        className: 'geo-ProductFullscreenView',
        ...
        sistineOptions: {
            events: {
                ...
                'doubletap .geo-ProductFullscreenView-content .geo-ProductThumbnailView': '_handleFullscreenClose'
            }
        },
        ...
        _handleFullscreenClose: function(ev) {
            if ($(ev.target).is('.geo-ProductThumbnailView')
                    || $(ev.target).closest('.geo-ProductThumbnailView').length) {
                ...
                var $destEl = $('.geo-CategoryView [data-path="' + productPath + '"]');
