...
require([
    ...
    'DemoScreensApp',
    'util/ScreensChannel'
], function($, DemoScreensApp, Channel) {
    'use strict';
    ...
    $(function() {
        if (Channel.getDisplay()) {
            ...
            var handleDisplayDataSuccess = function(displayData) {
                console.log('DemoScreensApp got data:', displayData);
                ...
                window.demoscreensapp = new DemoScreensApp(config);
            };

            // On failure just initialize the app as is
            var handleDisplayDataFailure = function() {
                window.demoscreensapp = new DemoScreensApp(defaultConfig);
            };
