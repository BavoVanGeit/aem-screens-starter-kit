 ...
 */
define('brand-pathname-placeholder/views/category', [
    'underscore',
    'jquery',
    'util/Util',
    'views/BaseView',
    'brand-pathname-placeholder/views/product-hero',
    'ux/views/SwipeGridView',
    'brand-pathname-placeholder/views/product-fullscreen'
    ...
    var CategoryView = BaseView.extend(/** @lends CategoryView.prototype */ {
        ...
        _handleProductActivation: function(ev, product, displayNo) {
            ...
            this._productFullscreenView.open($(ev.target).find('.geo-ProductThumbnailView'));
        ...
        _template: function(category) {
            var tpl = _.template('<div class="geo-CategoryView-title"><%= category.get("title") %></div>');
