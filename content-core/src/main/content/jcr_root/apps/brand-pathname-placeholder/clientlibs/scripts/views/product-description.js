 ...
 */
define('brand-pathname-placeholder/views/product-description', [
    'underscore',
    'jquery',
    'util/Util',
    'views/BaseView',
    'brand-pathname-placeholder/views/star-rating',
    'brand-pathname-placeholder/views/scrollable-panel',
    'brand-pathname-placeholder/views/variant-list'
